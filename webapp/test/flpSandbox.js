		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Application Using MockServer",
									"targetURL": "#brcomappmockserversapui5appmockserver-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomappmockserversapui5appmockserver-display": {
								"semanticObject": "brcomappmockserversapui5appmockserver",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.app.mockserver.sapui5appmockserver",
									"url": sap.ui.require.toUrl("br/com/app/mockserver/sapui5appmockserver")
								}
							}
						}
					}
